...
colnames(dataBS) <- c("ID", "Sr")
colnames(dataFS) <- c("ID", "Sr")
...
for (i in 1:length(IDOto)) {
  m <- as.matrix(dataBS[which(dataBS$ID==IDOto[i]),c(2)])
...
for (i in 1:length(IDOto)) {
  m <- as.matrix(dataFS[which(dataFS$ID==IDOto[i]),c(2)])
...
#Plot best solution Freshwater
FWplot <- plot(clust_F$k_3, type="sc", linetype="solid", cex=2)+
  ylim(-3,3)+ggtitle(expression("Sr/"~delta^18~O~"cluster centroids"))+
  labs(x="transect cell", y="scaled value")+
  theme(axis.text = element_text(size = 25, color="black"),
        axis.title = element_text(size = 25),
...
fishassign_B2 <- data.frame(ID=names(Bseries), 
                            clust2=factor(clust_B$k_4@cluster, 
                                           levels = c(1:4), 
                                           labels = c("BW Med saline|cold",
                                                      "BW Low saline|shift",
                                                      "BW High saline|const",
                                                      "BW low saline|cold")))
...
#cluster Bodden with cutoff test
clust_B <- tsclust(series = Bseries, type = "partitional",
                  k = 2L:6L,centroid = "dba",
                  seed = 94L,args = tsclust_args(dist = list(window.size =5L)))
...
#cluster FW with cutoff test
clust_F <- tsclust(series = Fseries, type = "partitional",
                  k = 2L:6L,centroid = "dba",
                  seed = 94L,args = tsclust_args(dist = list(window.size =5L)))
...
#Plot FW proportions
ggplot(fishassign_F, aes(capt, fill=clust))+
  geom_bar(position = "fill", width = .5)+theme_minimal()+
  labs(x="", y="proportion", fill="assigned cluster")+
  scale_fill_manual(breaks=c("FW low saline",
                             "FW high saline"), 
                    values = mypallette)+
  theme(axis.text.y = element_text(size = 25, color = "black"),
        axis.text.x = element_text(size = 25, color = "black"),
...
A <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW High saline|const",])+
  ...
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "High S, thermal const (N=24)",
                                     face = "bold", size = 8),
                    ymin = 8.5, ymax = 8.5, xmin = 1050, xmax = 1050)

B <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW Med saline|cold",])+
  geom_line(aes(dist, Sr*1000, group=ID), color="grey", size=.3, alpha=.8)+
  ...
  theme(legend.position = "none",
        ...
        axis.ticks.x = element_line(colour = "transparent"))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Int. S, thermal low (N=23)",
                                     face = "bold", size = 8),
                    ymin = 8.5, ymax = 8.5, xmin = 1050, xmax = 1050)

C <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW Low saline|shift"|Bgroup.clus$clust2=="BW Low saline|cold",])+
  geom_line(aes(dist, Sr*1000, group=ID), color="grey", size=.3, alpha=.8)+
  ...
  theme(legend.position = "none",
        ...
        axis.ticks.x = element_line(colour = "transparent"))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "Low S, thermal shift (N=39)",
                                     face = "bold", size = 8),
                    ymin = 8.5, ymax = 8.5, xmin = 1050, xmax = 1050)

A1 <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW High saline|const",])+
...
B1 <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW Med saline|cold",])+
  geom_line(aes(dist, d18O_res, group=ID), color="grey", size=.3, alpha=.8)+
...
C1 <- ggplot(Bgroup.clus[Bgroup.clus$clust2=="BW Low saline|shift"|Bgroup.clus$clust2=="BW Low saline|cold",])+
  geom_line(aes(dist, d18O_res, group=ID), color="grey", size=.3, alpha=.8)+
...
D <- ggplot(Fgroup.clus[Fgroup.clus$clust2=="FW high saline|shift",])+
  ...
  theme(legend.position = "none",
        ...
        axis.ticks.x = element_line(colour = "transparent"))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "FW high S, thermal shift (N=24)",
                                     face = "bold", size = 8),
                    ymin = 8.5, ymax = 8.5, xmin = 1050, xmax = 1050)
...
F1 <- ggplot(Fgroup.clus[Fgroup.clus$clust2=="FW med saline|shift",])+
  geom_line(aes(dist, Sr*1000, group=ID), color="grey", size=.3, alpha=.8)+
  ...
  theme(legend.position = "none",
        ...
        axis.ticks.x = element_line(colour = "transparent"))+
  coord_cartesian(clip = "off")+
  annotation_custom(grob = text_grob(label = "FW resident, thermal shift (N=6)",
                                     face = "bold", size = 8),
                    ymin = 8.5, ymax = 8.5, xmin = 1050, xmax = 1050)
...
F2 <- ggplot(Fgroup.clus[Fgroup.clus$clust2=="FW med saline|shift",])+
  geom_line(aes(dist, d18O_res, group=ID), color="grey", size=.3, alpha=.8)+
