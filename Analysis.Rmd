...
standata_growth = list(
  ...
  alinf = 2.5^2/0.3^2,
  blinf = 2.5/0.3^2,
  n_groupmax = as.integer(length(unique(growthdata[growthdata$sex==0,]$id))),
  n_group = as.integer(length(unique(growthdata[growthdata$sex==0,]$id))),
  n_group1 = as.integer(length(unique(growthdata[growthdata$sex==1,]$id))),
  group_id = growthdata$id
)
```
...
fit = stan(stancode, iter = 200, data = standata_growth,
