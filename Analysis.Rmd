...
```{r covariance d18O and Sr, include=FALSE}
#clean up
...
#Save data
write.table(otoint_lowres, "Data/Oto_LA-to-d18O_interpolation.txt", 
            row.names = F,dec = ".", sep = "\t")
```
...
ggplot(otoint_lifehist, aes(year, d18O_res))+
...
#Here you left, you dodo, now make the other figure
...
Fig <- ggarrange(Temp, Clust, align = "h")

png(filename = "Figures/Interaction_effects_growth.png", 
    width = 4500, height = 1800, res = 600)
annotate_figure(plot, top = text_grob("Effects of relative lifelong temperature and ecotype on pike growth", color = "black", face = "bold", size = 15))
dev.off()
```
