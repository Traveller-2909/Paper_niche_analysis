...
# different grouping, similar to Höhne et al.
stancode2 <- ("Data/Stancode/Growth_model_hierarchical4_ecotypes_3.stan")

fit = stan(stancode2, iter = 250, data = standata_growth_2, 
