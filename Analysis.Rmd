...
fit_large = stan(stancode4, iter = 40000, data = standata_growth_2, 
           model_name = "Individual pike growth",
           control = list(adapt_delta = 0.9, 
                          max_treedepth = 12))
...
#Pairs plots
pairs(fit, pars = c("LInf","k"))


print(fit,pars = c("k1_mu","k2_mu","k3_mu",
               "k4_mu","k5_mu","k6_mu",
               "k1_sig","k2_sig","k3_sig",
               "k4_sig","k5_sig","k6_sig"))
print(fit,pars = c("tZero1","tZero2","tZero3",
               "tZero4","tZero5","tZero6"))
